...
def print_setup_summary():
    ...
    print("\n🔧 TECHNICAL DETAILS:")
    print("   • Model ID: stability.stable-conservative-upscale-v1:0")
    print("   • Inference Profile: us.stability.stable-conservative-upscale-v1:0")
    print("   • Service: Amazon Bedrock Runtime")
    print("   • API: invoke_model")
    print("   • Input: Base64 encoded image + JSON parameters")
    print("   • Output: Base64 encoded upscaled image")
